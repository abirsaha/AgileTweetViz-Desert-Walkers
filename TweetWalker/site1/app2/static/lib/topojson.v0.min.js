...
topojson = function() {
    ...
    function e(e, r, o) {
        ...
        if (arguments.length > 1) {
            ...
            for (var p = 0, h = e.arcs.length; h > p;
                 ++p) u.push([p]);
        return n(e, {
    ...
    function n(t, e) {
        function n(t, e) {
            e.length && e.pop();
            for (var n, o = h[0 > t ? ~t : t], a = 0, i = o.length, c = 0, s = 0; i > a;
                 ++a) e.push([(c += (n = o[a])[0]) * f + d, (s += n[1]) * l + p]);
            0 > t && r(e, i)
        }
